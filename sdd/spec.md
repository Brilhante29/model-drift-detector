...
Este projeto prova que: deteccao de drift.

## Stack

python, pandas, scipy, prometheus, docker

## User-visible output

- Docker command: pending
- README opens with: # #22 model-drift-detector
- Benchmark table: drift_alarm_vs_baseline
